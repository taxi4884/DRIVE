...
$datum = new DateTime($teilnehmer['termin']);
...
DESCRIPTION:Praxistag zur Funkschulung – bitte um $zeit Uhr im Büro melden
END:VEVENT
END:VCALENDAR
ICS;
